...
const CartHeader = () => {
  ...
  return (
    <div
      style={{ backgroundColor: "#2f75f0" }}
      className="h-16 w-full  flex justify-between items-center fixed top-0 z-50"
    >
      ...
      >
        ...
        <Link
          className="cursor-pointer hover:bg-gray-100 hover:text-blue-700 px-7 py-2 text-white border border-white rounded-sm ml-auto mr-20 hover:border-gray-300 transition"
          to="/auth"
        >
          <div>
            <button>Login</button>
